...
-- Mô tả: Schema quản lý bán hàng xa xỉ Tam Sơn (with corrected columns)
-- ============================================================================
...
ALTER TABLE catalog_category_entity ADD CONSTRAINT fk_parent_id FOREIGN KEY (parent_id) REFERENCES catalog_category_entity(entity_id);
...
CREATE TABLE cataloginventory_stock_item (
    ...
    notify_stock_qty DECIMAL(12, 4) DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
ALTER TABLE customer_entity ADD CONSTRAINT fk_customer_website FOREIGN KEY (website_id) REFERENCES core_website(website_id);
ALTER TABLE customer_entity ADD CONSTRAINT fk_customer_store FOREIGN KEY (store_id) REFERENCES core_store(store_id);
...
ALTER TABLE admin_user ADD CONSTRAINT fk_admin_manager FOREIGN KEY (manager_id) REFERENCES admin_user(user_id);
